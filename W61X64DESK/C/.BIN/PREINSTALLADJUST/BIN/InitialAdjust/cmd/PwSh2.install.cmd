@echo on
rem *******************************************************
rem PwSh2.install.cmd
rem This Script Install PowerShell 2.0 at Windows Server
rem 2008 R2 Core via Dism.exe Command.
rem
...
rem %DISMEXE% /Online /Enable-Feature /FeatureName:NetFx2-ServerCore /norestart 
%DISMEXE% /Online /Enable-Feature /FeatureName:NetFx3 /norestart 
rem %DISMEXE% /Online /Enable-Feature /FeatureName:MicrosoftWindowsPowerShell /norestart
rem %DISMEXE% /Online /Enable-Feature /FeatureName:MicrosoftWindowsPowerShell-WOW64 /norestart
rem %DISMEXE% /Online /Enable-Feature /FeatureName:ServerManager-PSH-Cmdlets /norestart
rem %DISMEXE% /Online /Enable-Feature /FeatureName:BestPractices-PSH-Cmdlets /norestart
%DISMEXE% /Online /Enable-Feature /FeatureName:MicrosoftWindowsPowerShellISE /norestart
