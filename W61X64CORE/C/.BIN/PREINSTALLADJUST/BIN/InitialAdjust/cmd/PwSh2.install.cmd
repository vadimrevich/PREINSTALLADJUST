...
%DISMEXE% /Online /Enable-Feature /FeatureName:NetFx2-ServerCore /norestart 
rem %DISMEXE% /Online /Enable-Feature /FeatureName:NetFx3 /norestart 
%DISMEXE% /Online /Enable-Feature /FeatureName:MicrosoftWindowsPowerShell /norestart
%DISMEXE% /Online /Enable-Feature /FeatureName:MicrosoftWindowsPowerShell-WOW64 /norestart
%DISMEXE% /Online /Enable-Feature /FeatureName:ServerManager-PSH-Cmdlets /norestart
%DISMEXE% /Online /Enable-Feature /FeatureName:BestPractices-PSH-Cmdlets /norestart
rem %DISMEXE% /Online /Enable-Feature /FeatureName:MicrosoftWindowsPowerShellISE /norestart
